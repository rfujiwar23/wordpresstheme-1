...
function theme_files()
{
    ...
    wp_enqueue_script( 'nav-js', get_template_directory_uri() . '/js/nav.js', array('jquery'), true, true);
...
function custom_widgets() {
    ...
    register_sidebar( array(
      "name"          => 'Footer Widgets',
      "id"            => 'footer_widgets',
      "before_widget" => '<div class="col-lg-3 col-md-3"><div class="footer-widget small">',
